...
# ACDS 20.1 720 win32 2024.06.20.00:22:16
...
# ----------------------------------------
# If ltf is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ltf.vo"
fi
