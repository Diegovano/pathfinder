...
module nios_sys_mm_interconnect_0 (
		...
		input  wire [23:0] dma_0_read_master_address,                 //               dma_0_read_master.address
		...
		input  wire [23:0] dma_0_control_port_slave_readdata,         //                                .readdata
		output wire [23:0] dma_0_control_port_slave_writedata,        //                                .writedata
	...
	wire   [24:0] dma_0_read_master_translator_avalon_universal_master_0_address;            // dma_0_read_master_translator:uav_address -> dma_0_read_master_agent:av_address
	...
	wire          rsp_mux_002_src_valid;                                                     // rsp_mux_002:src_valid -> dma_0_read_master_agent:rp_valid
	wire  [100:0] rsp_mux_002_src_data;                                                      // rsp_mux_002:src_data -> dma_0_read_master_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                     // dma_0_read_master_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [7:0] rsp_mux_002_src_channel;                                                   // rsp_mux_002:src_channel -> dma_0_read_master_agent:rp_channel
	wire          rsp_mux_002_src_startofpacket;                                             // rsp_mux_002:src_startofpacket -> dma_0_read_master_agent:rp_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                               // rsp_mux_002:src_endofpacket -> dma_0_read_master_agent:rp_endofpacket
	...
	wire   [24:0] dma_0_write_master_translator_avalon_universal_master_0_address;           // dma_0_write_master_translator:uav_address -> dma_0_write_master_agent:av_address
	...
	wire  [100:0] rsp_mux_003_src_data;                                                      // rsp_mux_003:src_data -> dma_0_write_master_agent:rp_data
	wire          rsp_mux_003_src_ready;                                                     // dma_0_write_master_agent:rp_ready -> rsp_mux_003:src_ready
	wire    [7:0] rsp_mux_003_src_channel;                                                   // rsp_mux_003:src_channel -> dma_0_write_master_agent:rp_channel
	...
	wire   [24:0] dma_0_control_port_slave_agent_m0_address;                                 // dma_0_control_port_slave_agent:m0_address -> dma_0_control_port_slave_translator:uav_address
	...
	wire  [101:0] dma_0_control_port_slave_agent_rf_source_data;                             // dma_0_control_port_slave_agent:rf_source_data -> dma_0_control_port_slave_agent_rsp_fifo:in_data
	...
	wire  [101:0] dma_0_control_port_slave_agent_rsp_fifo_out_data;                          // dma_0_control_port_slave_agent_rsp_fifo:out_data -> dma_0_control_port_slave_agent:rf_sink_data
	...
	wire  [100:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> dma_0_control_port_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                     // dma_0_control_port_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [7:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> dma_0_control_port_slave_agent:cp_channel
	...
	wire          dma_0_read_master_agent_cp_valid;                                          // dma_0_read_master_agent:cp_valid -> router_002:sink_valid
	wire  [100:0] dma_0_read_master_agent_cp_data;                                           // dma_0_read_master_agent:cp_data -> router_002:sink_data
	wire          dma_0_read_master_agent_cp_ready;                                          // router_002:sink_ready -> dma_0_read_master_agent:cp_ready
	wire          dma_0_read_master_agent_cp_startofpacket;                                  // dma_0_read_master_agent:cp_startofpacket -> router_002:sink_startofpacket
	wire          dma_0_read_master_agent_cp_endofpacket;                                    // dma_0_read_master_agent:cp_endofpacket -> router_002:sink_endofpacket
	wire          router_002_src_valid;                                                      // router_002:src_valid -> cmd_demux_002:sink_valid
	wire  [100:0] router_002_src_data;                                                       // router_002:src_data -> cmd_demux_002:sink_data
	...
	wire  [100:0] dma_0_write_master_agent_cp_data;                                          // dma_0_write_master_agent:cp_data -> router_003:sink_data
	...
	wire  [100:0] dma_0_control_port_slave_agent_rp_data;                                    // dma_0_control_port_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [100:0] cmd_demux_002_src0_data;                                                   // cmd_demux_002:src0_data -> cmd_mux_007:sink2_data
	...
	wire  [100:0] cmd_demux_003_src0_data;                                                   // cmd_demux_003:src0_data -> cmd_mux_001:sink1_data
	...
	wire  [100:0] rsp_demux_001_src1_data;                                                   // rsp_demux_001:src1_data -> rsp_mux_003:sink0_data
	...
	wire  [100:0] rsp_demux_007_src2_data;                                                   // rsp_demux_007:src2_data -> rsp_mux_002:sink0_data
	...
	nios_sys_mm_interconnect_0_router_003 router_003 (
	...
	nios_sys_mm_interconnect_0_router_004 router_007 (
	...
	nios_sys_mm_interconnect_0_router_008 router_008 (
	...
	nios_sys_mm_interconnect_0_router_004 router_009 (
	...
	nios_sys_mm_interconnect_0_router_004 router_010 (
	...
	nios_sys_mm_interconnect_0_router_011 router_011 (
	...
	nios_sys_mm_interconnect_0_cmd_demux_002 cmd_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_cmd_demux_002 cmd_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_cmd_mux_007 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_cmd_demux_002 rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_cmd_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_cmd_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_rsp_demux_001 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_cmd_demux_002 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_cmd_demux_002 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_rsp_demux_007 rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_rsp_mux_002 rsp_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_rsp_mux_002 rsp_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_sys_mm_interconnect_0_avalon_st_adapter_007 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
