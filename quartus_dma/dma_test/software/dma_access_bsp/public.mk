...
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nio2_sys.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1001050
SOPC_SYSID_FLAG += --sidp=0x1001050
ELF_PATCH_FLAG  += --sidp 0x1001050

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1718290699
SOPC_SYSID_FLAG += --timestamp=1718290699
ELF_PATCH_FLAG  += --timestamp 1718290699
