...
module nios2_system_mm_interconnect_0 (
	...
	wire  [101:0] timestamp_timer_s1_agent_rf_source_data;                                   // timestamp_timer_s1_agent:rf_source_data -> timestamp_timer_s1_agent_rsp_fifo:in_data
	...
	wire  [101:0] timestamp_timer_s1_agent_rsp_fifo_out_data;                                // timestamp_timer_s1_agent_rsp_fifo:out_data -> timestamp_timer_s1_agent:rf_sink_data
	...
	wire          cmd_mux_003_src_valid;                                                     // cmd_mux_003:src_valid -> timestamp_timer_s1_agent:cp_valid
	wire  [100:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> timestamp_timer_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                     // timestamp_timer_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> timestamp_timer_s1_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                             // cmd_mux_003:src_startofpacket -> timestamp_timer_s1_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                               // cmd_mux_003:src_endofpacket -> timestamp_timer_s1_agent:cp_endofpacket
	...
	wire          timestamp_timer_s1_agent_rp_valid;                                         // timestamp_timer_s1_agent:rp_valid -> router_005:sink_valid
	wire  [100:0] timestamp_timer_s1_agent_rp_data;                                          // timestamp_timer_s1_agent:rp_data -> router_005:sink_data
	wire          timestamp_timer_s1_agent_rp_ready;                                         // router_005:sink_ready -> timestamp_timer_s1_agent:rp_ready
	wire          timestamp_timer_s1_agent_rp_startofpacket;                                 // timestamp_timer_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          timestamp_timer_s1_agent_rp_endofpacket;                                   // timestamp_timer_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          timestamp_timer_s1_agent_rdata_fifo_src_valid;                             // timestamp_timer_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] timestamp_timer_s1_agent_rdata_fifo_src_data;                              // timestamp_timer_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          timestamp_timer_s1_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_003:in_0_ready -> timestamp_timer_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                         // avalon_st_adapter_003:out_0_valid -> timestamp_timer_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                          // avalon_st_adapter_003:out_0_data -> timestamp_timer_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                         // timestamp_timer_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                         // avalon_st_adapter_003:out_0_error -> timestamp_timer_s1_agent:rdata_fifo_sink_error
	...
	nios2_system_mm_interconnect_0_router_007 router_007 (
	...
	nios2_system_mm_interconnect_0_cmd_mux_002 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_system_mm_interconnect_0_rsp_demux_002 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
	...
	nios2_system_mm_interconnect_0_avalon_st_adapter_005 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
